...
public class AdapterVideoAll extends RecyclerView.Adapter<AdapterVideoAll.MyViewHolder> {
    ...
    public AdapterVideoAll(List<VideoModel> video) {
        this.video = video;
    }
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.desaint_list_video, parent, false);
        return new AdapterVideoAll.MyViewHolder(itemView, listener);
    }
